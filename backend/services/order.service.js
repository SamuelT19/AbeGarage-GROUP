...
const createOrder = async (orderData) => {
  try {
    await withTransaction(async (connection) => {
      ...
      const rows1 = await query(connection,query1, [
      ...
      // Insert into the order_services table
        ...
        const orderServicesRows = await query(connection,orderServicesQuery);
      ...
      const rows4 = await query(connection,query4, [
        order_id,
      ...
      // Insert into the order_status table
        ...
        const orderStatusRows = await query(connection,orderStatusQuery, [
          order_id,
