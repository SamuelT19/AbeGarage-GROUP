...
async function addCustomer(customer) {
    ...
    try {
        ...
        const result = await conn.query(query, [customer.customer_email, customer.customer_phone_number, customer_hash]);
        ...
        const queryInfo = "INSERT INTO customer_info (customer_id, customer_first_name, customer_last_name, active_customer_status) VALUES (?, ?, ?, ?)";
        const resultInfo = await conn.query(queryInfo, [customer_id, customer.customer_first_name, customer.customer_last_name, 1]);
